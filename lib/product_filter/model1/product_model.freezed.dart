...
class _$_ProductModel implements _ProductModel {
  const _$_ProductModel(
      ...
      final List<RatingModel> rating = const []})
      : _rating = rating;
  ...
  @override
  String toString() {
    return 'ProductModel(id: $id, name: $name, photo: $photo, regular_price: $regular_price, sale_price: $sale_price, discount: $discount, status: $status, id_list: $id_list, rating: $rating)';
  }
...
abstract class _ProductModel implements ProductModel {
  const factory _ProductModel(
      ...
      final List<RatingModel> rating}) = _$_ProductModel;
